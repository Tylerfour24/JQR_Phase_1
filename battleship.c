...
void placeships(struct Ship ship, int onedim, int twodim, char battlegrid[][10]);
...
//This successfully creates the empty board
	...
	placeships(Aircraft_Carrier, onedim, twodim, battlegrid);
	placeships(Battleship, onedim, twodim, battlegrid);
	placeships(Cruiser, onedim, twodim, battlegrid);
	placeships(Destroyer, onedim, twodim, battlegrid);
	placeships(Patrol_Boat, onedim, twodim, battlegrid);
	placeships(Submarine, onedim, twodim, battlegrid);
